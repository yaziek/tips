...
public class PersonCreator {
    ...
    public Person createPerson() {
        ...
        double wage = dataReader.getDouble();
        System.out.println("Ile płacisz barmanowi:"); //add option YES or NOT
        double bartender = dataReader.getDouble(); // add percentage option
        System.out.println("Srednio ile dziennie wydajesz na posiłki:");
        double dinner = dataReader.getDouble();
        System.out.println("Ile płacisz na zmywak:");
        double sink = dataReader.getDouble();
        System.out.println("Dodatkowe dzienne koszty:");
        double other = dataReader.getDouble();

        return new Person(firstName, lastName, wage, bartender, dinner, sink, other);
    }
}
